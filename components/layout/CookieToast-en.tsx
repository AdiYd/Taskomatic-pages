...
interface CookieToastEnProps {
  onAccept?: () => void;
  onDecline?: () => void;
  className?: string;
}

export function CookieToastEn({
  onAccept,
  onDecline,
  className,
}: CookieToastEnProps) {
  ...
  return (
    <>
      <div
        className={cn(
          'fixed bottom-4 left-4 z-9999 w-[90%] sm:max-w-105',
          'pointer-events-auto',
          className
        )}
      >
        ...
        >
          ...
          <button
            onClick={handleClose}
            className={cn(
              'absolute top-3 right-3 z-10 rounded-lg',
          ...
          <div dir="ltr" className="space-y-4">
            {/* Title */}
            <div className="flex flex-row-reverse items-baseline justify-end gap-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              user traffic on our site. By continuing to use this site, you
