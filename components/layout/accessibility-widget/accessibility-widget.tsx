  ...
  return (
    <>
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <div className={cn('fixed bottom-8 z-50', positionClasses)}>
            <Button
              ...
              variant="info"
              className={cn(
                'border-primary/30 hover:border-primary group relatives rounded-full border-2 shadow-lg transition-transform hover:scale-105',
        ...
        <PopoverContent
          className="bg-background relative max-h-[80vh] max-w-96 overflow-y-auto border pt-0 shadow-lg backdrop-blur-sm max-sm:right-16"
          //   align="end"
          //   side="top"
        >
          <div className="space-y-4">
            ...
            <div className="sticky top-0 z-20 flex items-center justify-between border-b pt-2 pb-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold">נגישות</h3>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 text-sm font-medium">
                ...
                ריווח אותיות: {settings.letterSpacing}px
              </label>
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
