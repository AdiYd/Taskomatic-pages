  ...
  plans: [
    {
      ...
      features: ['עד 100 משימות', 'אחסון בענן בסיסי', 'תמיכה בקהילה'],
      cta: 'התחל עכשיו',
      highlighted: false,
    },
    {
...
export const TESTIMONIALS_SECTION = {
  ...
  testimonials: [
    {
      quote:
        'Taskomatic שינה את דרך הניהול של הצוות שלי. הוא פשוט, יעיל ויחסוך זמן יקר',
      author: 'ירון כהן',
      role: 'מנהל פרויקטים',
  ...
  faqs: [
    {
      ...
      answer:
        'כן! התוכנית הבסיסית שלנו בחינם לתמיד. אנו גם מציעים תוכניות בתשלום עם מאפיינים נוספים.',
    },
    {
      question: 'האם אני יכול לשתף משימות עם הצוות שלי?',
      answer:
        'בהחלט! כל התוכניות שלנו (אפילו החינמית) תומכות בשיתוף פעולה בצוות בזמן אמת.',
    },
    {
      question: 'כמה משימות אני יכול ליצור?',
      answer:
        'בתוכנית הבסיסית, מוגבל ל-100 משימות. בתוכניות משלמות - בלתי מוגבל.',
    },
    {
      question: 'האם הנתונים שלי בטוחים?',
      answer:
        'כן! אנו משתמשים בהצפנה ברמת סטנדרט תעשיתית ותא הנתונים שלנו עומד בתקנים בינלאומיים.',
    },
    {
      question: 'האם אתם מציעים תמיכה בעברית?',
      answer:
        'כן בהחלט! המערכת שלנו באה גם בעברית, וקבוצת התמיכה שלנו מדברת עברית בשטף.',
    },
    {
      question: 'אני יכול לייצא את הנתונים שלי?',
      answer:
        'כן, אתה יכול לייצא את כל הנתונים שלך בכל זמן בפורמט CSV או JSON.',
    },
  ],
};
